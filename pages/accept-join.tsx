...
export default function AcceptJoin() {
  ...
  return (
    <div className="wl-accept-join w-screen mt-[56px] flex flex-col items-center gap-10 container mx-auto">
      <Image
        isCircle
      ...
      />
      <Text size="h1">
        {`You have accepted the invitation to team ${
      ...
      <div className="flex flex-col md:flex-row w-full lg:items-center justify-center gap-4">
        ...
        <Button
          size="lg"
          type="primary"
          onClick={() => push('/user/teams')}
          ariaLabel="View your teams"
        >
          View your teams
        </Button>
      </div>
